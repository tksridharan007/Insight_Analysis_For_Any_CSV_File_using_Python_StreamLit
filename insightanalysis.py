...
def time_series():
    ...
    st.markdown("<h4>!! Kindly arrange the columns in the data set according to the following order!!</h4>", unsafe_allow_html=True)
    ...
    st.markdown("<h4>!! 2. In column 3 Keep the value of the year!!</h4>", unsafe_allow_html=True)
